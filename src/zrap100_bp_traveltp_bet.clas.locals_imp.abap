CLASS lhc_zrap100_r_traveltp_bet DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
...
CLASS lhc_zrap100_r_traveltp_bet IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_bet,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atravbet FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtravbet FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF ZRAP100_R_TravelTP_bet IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_bet IN LOCAL MODE
      ENTITY Travel
...
**************************************************************************
 METHOD deductDiscount.
   DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_bet.
...
**************************************************************************
 METHOD copyTravel.
    DATA:
      travels       TYPE TABLE FOR CREATE zrap100_r_traveltp_bet\\travel.
